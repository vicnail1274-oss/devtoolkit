...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: 'Parse and explain cron expressions with human-readable descriptions, field breakdown, and next execution times.',
  ...
  {
    title: 'SVG Optimizer',
    description: 'Optimize and minify SVG files by removing unnecessary metadata, comments, and default values to reduce file size.',
...
export const blogToolMap: Record<string, string[]> = {
  ...
  'cron-expression-cheat-sheet': ['cron-generator', 'cron-parser', 'chmod-calculator'],
  'cron-expression-builder-guide': ['cron-generator', 'cron-parser', 'chmod-calculator'],
