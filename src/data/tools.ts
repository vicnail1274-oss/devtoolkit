...
export const blogToolMap: Record<string, string[]> = {
  ...
  'json-vs-yaml-vs-toml': ['yaml-to-json', 'json-formatter', 'json-schema-generator'],
  ...
  'markdown-to-html-converter-free': ['markdown-to-html', 'markdown-preview-editor', 'html-formatter'],
  ...
  'css-color-picker-hex-rgb-converter': ['color-converter', 'color-palette-generator'],
  ...
  'best-free-developer-tools-2026': ['json-formatter', 'regex-tester', 'base64', 'cron-generator'],
  'top-10-free-online-dev-tools': ['json-formatter', 'regex-tester', 'base64', 'cron-generator'],
  'essential-ai-developer-tools-2026': ['ai-code-review', 'ai-doc-generator', 'ai-sql-builder', 'token-counter'],
